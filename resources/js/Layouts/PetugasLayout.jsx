...
// Anda mungkin memerlukan komponen lain seperti ApplicationLogo, NavLink, Dropdown, ResponsiveNavLink
// Sesuaikan import berdasarkan komponen yang Anda miliki dan gunakan dari struktur Breeze/Jetstream.

// Contoh Komponen NavLink (jika belum ada atau berbeda)
...
// Contoh Komponen ResponsiveNavLink (jika belum ada atau berbeda)
...
export default function PetugasLayout({ user, header, children }) {
            ...
            <nav className="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="shrink-0 flex items-center">
                                <Link href={route('welcome')}> {/* Ganti 'welcome' dengan rute halaman utama Anda jika berbeda */}
                                    {/* Ganti dengan komponen Logo Aplikasi Anda jika ada */}
                                    <span className="text-xl font-semibold dark:text-white">PMAQ Tenda (Petugas)</span>
                                </Link>
                            </div>

                            {/* Navigation Links - Spesifik untuk Petugas */}
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink href={route('petugas.dashboard')} active={route().current('petugas.dashboard')}>
                                    Dashboard Petugas
                                </NavLink>
                                {/* Tambahkan NavLink lain di sini jika Petugas Lapangan punya menu lain */}
                                {/* Contoh:
                                <NavLink href={route('petugas.jadwal')} active={route().current('petugas.jadwal')}>
                                    Lihat Jadwal Saya
                                </NavLink>
                                */}
                            </div>
                        ...
                        <div className="hidden sm:flex sm:items-center sm:ms-6">
                            <div className="ms-3 relative">
                                {/* Ganti dengan komponen Dropdown yang Anda miliki */}
                                <button
                                    type="button"
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink href={route('petugas.dashboard')} active={route().current('petugas.dashboard')}>
                            Dashboard Petugas
                        </ResponsiveNavLink>
                        {/* Tambahkan ResponsiveNavLink lain di sini jika ada */}
                    </div>
