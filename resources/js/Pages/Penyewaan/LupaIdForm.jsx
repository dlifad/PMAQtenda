                    ...
                    <div className="container mx-auto px-4 max-w-lg">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600 mt-2 text-sm">
                                Masukkan detail berikut untuk membantu kami
                                menemukan ID penyewaan Anda.
                            </p>
                        </div>
                        <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <InputError
                                        message={errors.tanggal_sewa_lupa}
                                        className="mt-1 text-xs"
                                    />
                                        ...
                                        <div className="bg-gray-50 px-6 py-3 border-b border-gray-200 rounded-t-lg">
                                            <div className="flex items-center">
                                                ...
                                                <h2 className="text-md font-semibold text-gray-700">
                                                    ID Penyewaan Ditemukan (
                                                    {foundPenyewaanIds.length})
                                                </h2>
                                            </div>
                                        </div>
                                        <div className="bg-white p-4 rounded-b-lg">
                                            <p className="text-xs text-gray-500 mb-3">
                                                Klik pada ID untuk melihat
                                                detail penyewaan.
                                            </p>
                                            <ul className="space-y-3">
                                                {foundPenyewaanIds.map(
                                                    (item) => (
                                                        <li
                                                            key={item.id}
                                                            className="p-3 bg-gray-50 hover:bg-green-50 border border-gray-200 hover:border-green-300 rounded-md flex justify-between items-center text-sm transition-colors group"
                                                        >
                                                            <div>
                                                                <Link
                                                                    href={route(
                                ...
                                !searchError && (
                                    <div className="mt-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700 rounded-md">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm">
                                                Tidak ada riwayat penyewaan yang
                                                ditemukan untuk kombinasi data
                                                yang dimasukkan.
                                            </span>
                                        </div>
                                    </div>
